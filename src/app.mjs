...
export const createApp = (service) => {
  ...
  app.post('/access-performance-adjudication-reviews', (request, response, next) => {
    try {
  ...
  app.get('/access-performance-adjudication-reviews/:id', (request, response, next) => {
    try {
  ...
  app.post('/access-performance-adjudication-reviews/:id/:action', (request, response, next) => {
    try {
